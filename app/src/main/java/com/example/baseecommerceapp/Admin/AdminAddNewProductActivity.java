...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void storeProductInformation() {
        ...
        loadingBar.setTitle(getString(R.string.adding_new_product));
        loadingBar.setMessage(getString(R.string.dear_admin_please_wait_while_we_are_adding_product_now));
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AdminAddNewProductActivity.this, getString(R.string.error) + massage, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(AdminAddNewProductActivity.this, getString(R.string.product_image_uploaded_successfully), Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        Toast.makeText(AdminAddNewProductActivity.this, getString(R.string.getting_product_image_URL_successfully), Toast.LENGTH_SHORT).show();
                ...
                addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(AdminAddNewProductActivity.this, getString(R.string.product_is_added_successfully), Toast.LENGTH_SHORT).show();
                        } else {

                            loadingBar.dismiss();
                            String massege = task.getException().toString();
                            Toast.makeText(AdminAddNewProductActivity.this, getString(R.string.error) + massege, Toast.LENGTH_SHORT).show();
                        }
